...
# Flutter InAppWebView Plugin [![Share on Twitter](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=Flutter%20InAppBrowser%20plugin!&url=https://github.com/arrrrny/zikzak_inappwebview&hashtags=flutter,flutterio,dart,dartlang,webview) [![Share on Facebook](https://img.shields.io/badge/share-facebook-blue.svg?longCache=true&style=flat&colorB=%234267b2)](https://www.facebook.com/sharer/sharer.php?u=https%3A//github.com/arrrrny/zikzak_inappwebview)
...
[![Pub](https://img.shields.io/pub/v/zikzak_inappwebview?include_prereleases)](https://pub.dartlang.org/packages/zikzak_inappwebview)
[![Pub Points](https://img.shields.io/pub/points/zikzak_inappwebview)](https://pub.dev/packages/zikzak_inappwebview/score)
[![Pub Popularity](https://img.shields.io/pub/popularity/zikzak_inappwebview)](https://pub.dev/packages/zikzak_inappwebview/score)
[![Pub Likes](https://img.shields.io/pub/likes/zikzak_inappwebview)](https://pub.dev/packages/zikzak_inappwebview/score)
...
[![GitHub forks](https://img.shields.io/github/forks/arrrrny/zikzak_inappwebview?style=social)](https://github.com/arrrrny/zikzak_inappwebview)
[![GitHub stars](https://img.shields.io/github/stars/arrrrny/zikzak_inappwebview?style=social)](https://github.com/arrrrny/zikzak_inappwebview)
...
- Read the online [API Reference](https://pub.dartlang.org/documentation/zikzak_inappwebview/latest/) to get the **full API documentation**.
...
- Check the [zikzak_inappwebview_examples](https://github.com/arrrrny/zikzak_inappwebview_examples) repository for project examples
- Check the [zikzak_inappwebview/example/integration_test/webview_flutter_test.dart](https://github.com/arrrrny/zikzak_inappwebview/blob/master/zikzak_inappwebview/example/integration_test/webview_flutter_test.dart) file for other code examples
- [Flutter Browser App](https://github.com/arrrrny/flutter_browser_app): A Full-Featured Mobile Browser App (such as the Google Chrome mobile browser) created using Flutter and the features offered by the zikzak_inappwebview plugin
